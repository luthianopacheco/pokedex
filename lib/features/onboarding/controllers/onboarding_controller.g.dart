...
mixin _$OnboardingController on OnboardingControllerBase, Store {
  late final _$currentPageAtom = Atom(
    name: 'OnboardingControllerBase.currentPage',
    context: context,
  );
  ...
  late final _$OnboardingControllerBaseActionController = ActionController(
    name: 'OnboardingControllerBase',
    context: context,
  );
  ...
  void nextPage() {
    final _$actionInfo = _$OnboardingControllerBaseActionController.startAction(
      name: 'OnboardingControllerBase.nextPage',
    );
    try {
