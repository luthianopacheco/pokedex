...
mixin _$PokemonController on PokemonControllerBase, Store {
  ...
  late final _$pokemonsTypeAtom = Atom(
    name: 'PokemonControllerBase.pokemonsType',
    context: context,
  );
  ...
  late final _$orderOptionsAtom = Atom(
    name: 'PokemonControllerBase.orderOptions',
    context: context,
  );
  ...
  late final _$selectedTypeAtom = Atom(
    name: 'PokemonControllerBase.selectedType',
    context: context,
  );
  ...
  late final _$selectedOrderAtom = Atom(
    name: 'PokemonControllerBase.selectedOrder',
    context: context,
  );
  ...
  late final _$isLoadingMoreAtom = Atom(
    name: 'PokemonControllerBase.isLoadingMore',
    context: context,
  );
  ...
  late final _$errorMessageAtom = Atom(
    name: 'PokemonControllerBase.errorMessage',
    context: context,
  );
  ...
  Future<void> getPokemons() {
    return _$fetchPokemonsAsyncAction.run(() => super.getPokemons());
  }
